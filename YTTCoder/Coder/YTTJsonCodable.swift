...
public class YTTJsonCodable {
    ...
    public class func jsonToObject<T: Decodable>(type: T.Type, jsonStr: String) throws -> T {
    ...
    /// - Returns: 转换后的字符串
    /// - Throws: 异常(YTTJsonCodableError)
    public class func objectToJson<T: Encodable>(object: T) throws -> String {
        do {
