...
public class YTTStringCoder {
    ...
    func toDictionary<Key, Value>(keyType: Key.Type, valueType: Value.Type) throws -> Dictionary<Key, Value> where Key: Hashable {
    ...
    /// - Returns: 转化后的数组
    /// - Throws: 异常(YTTJsonCodableError)
    func toArray<Element>(elementType: Element.Type) throws -> Array<Element> {
    ...
    /// - Returns: 时间戳
    func toDate(_ formatterStr: String) -> Date? {
